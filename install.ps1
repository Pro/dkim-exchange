...
# Exchange 2016 CU20 (15.1.2242.4)
# Exchange 2016 CU23 (15.1.2507.4)
...
# Exchange 2019 CU9 (15.2.858.5)
# Exchange 2019 CU12 (15.2.1118.7)

write-host "Detecting Exchange version ... " -f "cyan"
$hostname = hostname
$exchserver = Get-ExchangeServer -Identity $hostname
$EXDIR="$env:ProgramFiles\Exchange DkimSigner"
$EXVER="Unknown"
...
} elseif (($exchserver.admindisplayversion).major -eq 15 -and ($exchserver.admindisplayversion).minor -eq 1 -and ($exchserver.admindisplayversion).build -eq 1913) {
...
} elseif (($exchserver.admindisplayversion).major -eq 15 -and ($exchserver.admindisplayversion).minor -eq 1 -and ($exchserver.admindisplayversion).build -eq 2507) {
	$EXVER="Exchange 2016 CU23"
...
} elseif (($exchserver.admindisplayversion).major -eq 15 -and ($exchserver.admindisplayversion).minor -eq 2 -and ($exchserver.admindisplayversion).build -eq 529) {
...
} elseif (($exchserver.admindisplayversion).major -eq 15 -and ($exchserver.admindisplayversion).minor -eq 2 -and ($exchserver.admindisplayversion).build -eq 1118) {
	$EXVER="Exchange 2019 CU12"
} else {
