...
namespace Exchange.DkimSigner
{
    ...
    /// </summary>
    public sealed class DkimSigningAgentFactory : SmtpReceiveAgentFactory
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DkimSigningAgentFactory"/> class.
        /// </summary>
        public DkimSigningAgentFactory()
        {
        ...
        {
            return new DkimSigningAgent(dkimSigner);
        }
