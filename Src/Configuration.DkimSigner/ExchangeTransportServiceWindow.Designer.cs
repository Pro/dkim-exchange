namespace Configuration.DkimSigner
{
    partial class ExchangeTransportServiceWindow
    {
        ...
        private void InitializeComponent()
        {
			...
			// btDisable
			// 
			this.btDisable.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.btClose.Location = new System.Drawing.Point(403, 288);
			...
			this.dgvTransportServiceAgents.RowHeadersWidth = 51;
			...
			this.dgvcPriority.MinimumWidth = 6;
			...
			this.dgvcEnabled.MinimumWidth = 6;
			...
			this.textBoxHint.BackColor = System.Drawing.SystemColors.Control;
			this.textBoxHint.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.textBoxHint.Cursor = System.Windows.Forms.Cursors.Default;
			this.textBoxHint.Location = new System.Drawing.Point(13, 284);
			this.textBoxHint.Multiline = true;
			this.textBoxHint.Name = "textBoxHint";
			this.textBoxHint.ReadOnly = true;
			this.textBoxHint.Size = new System.Drawing.Size(372, 27);
			this.textBoxHint.TabIndex = 8;
			this.textBoxHint.Text = "The DKIM signing agent (Exchange DkimSigner) should generally be last in the list" +
    " (have the highest priority number).";
			// 
